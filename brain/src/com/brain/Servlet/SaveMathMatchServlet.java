...
public class SaveMathMatchServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public SaveMathMatchServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		mathMatch.setId(user.getId());
		mathMatch.setScore(score);
		MathMatchService mathMatchService = new MathMatchService();
		if(mathMatchService.saveMathMatchScore(mathMatch)){
			jb.put("avg", mathMatchService.getAvg(user.getId()));
			jb.put("code", 1);
		}else{
			jb.put("code", 0);
		}
