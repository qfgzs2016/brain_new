...
<div class="quiz-heading">
           <img alt="颜色" class="badge-image" id="pic-color" src="colorMatch/img/ColorMatch.png">
           <h2>颜色匹配</h2>
           <p class="light">
           		<a>认知速度</a>
           </p>
...
<div class="gametips">
          <a href="colorMatch/colorMatch.jsp#game-help" class="gametips-heading"> 游戏介绍与帮助   </a>
          <div id="game-help" class="gametips-details">
              <h5>基本操作&游戏帮助</h5>
              <p>游戏开始右边会出现一张颜色图，请记住它的颜色，并与右边字意比较是否相同。</p>
              <hr>
              <h5>游戏介绍</h5>
              <p>颜色匹配，需要你在极短的时间内做出正确的判断。它训练的是你的反应速度。你的反应越快，接受新事物、适应新环境的能力就越强。因此，这是一切智力提升的前提。练好快速匹配，才能拥有高效的学习和思维能力。</p>
          </div>
</div>
